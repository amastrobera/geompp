...
class Polyline3D {
 public:
  ...
  static Polyline3D Make(std::vector<Point3D> const& points, int decimal_precision = DP_THREE);
  ...
  bool AlmostEquals(Polyline3D const& other, int decimal_precision = DP_THREE) const;
...
#pragma region Geometrical Operations
  ...
  bool Intersects(Polyline3D const& other, int decimal_precision = DP_THREE) const;
