...
#pragma region Geometrical Operations
  ...
  Polyline3D Reduce(PolylineDecimationParams const& settings = PolylineDecimationParams{}) const;
  ...
  Polyline3D Expand(PolylineExpansionParams const& settings = PolylineExpansionParams{}) const;
