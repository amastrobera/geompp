...
LineSegment3D LineSegment3D::Make(Point3D const& p0, Point3D const& p1, int decimal_precision) {
...
Line3D LineSegment3D::ToLine(int decimal_precision) const { return Line3D::Make(P0, P1, decimal_precision); }
...
bool LineSegment3D::Contains(Point3D const& point, int decimal_precision) const {
...
std::string LineSegment3D::ToWkt(int decimal_precision) const {
...
void LineSegment3D::ToFile(std::string const& path, int decimal_precision) const {
  try {
