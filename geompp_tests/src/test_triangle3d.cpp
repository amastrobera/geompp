...
TEST(Triangle3D, Constructor) {
  //auto t = g::Triangle3D::Make(g::Point2D(-1, 1), g::Point2D(0, -1), g::Point2D(1, 1));

  //ASSERT_EQ(g::Point2D(0, 0.333), t.Centroid());

  //EXPECT_ANY_THROW(g::Triangle3D::Make(g::Point2D(-1, 1), g::Point2D(0, -1), g::Point2D(0, -1)));
  //EXPECT_ANY_THROW(g::Triangle3D::Make(g::Point2D(-1, 1), g::Point2D(-1, 1), g::Point2D(0, -1)));
  //EXPECT_ANY_THROW(g::Triangle3D::Make(g::Point2D(), g::Point2D(), g::Point2D()));
}
...
//  int prec = 4;
//  auto t_ccw = g::Triangle3D::Make(g::Point2D(-1, 1), g::Point2D(0, -1), g::Point2D(1, 1), prec);
//
...
//  int prec = 4;
//  auto t = g::Triangle3D::Make(g::Point2D(-1, 1), g::Point2D(0, -1), g::Point2D(1, 1), prec);
//
...
TEST(Triangle3D, Wkt) {
  ASSERT_EQ("TRIANGLE (0 0, 1 1, 0 2)",
            g::Triangle3D::Make(g::Point2D(0, 0), g::Point2D(1, 1), g::Point2D(0, 2)).ToWkt());
  ASSERT_EQ("TRIANGLE (56491.62 -795.97, -9137.37 10.36, 321.13 206.62)",
            g::Triangle3D::Make(g::Point2D(56491.6164, -795.97416), g::Point2D(-9137.3679, 10.35678),
                                g::Point2D(321.1302, 206.619749))
                .ToWkt(2));

  EXPECT_EQ(g::Triangle3D::Make(g::Point2D(0, 0), g::Point2D(1, 1), g::Point2D(0, 2)),
...
TEST(Triangle3D, ToFile) {
  ...
  auto s = g::Triangle3D::Make(g::Point2D(), g::Point2D(1, 0), g::Point2D(0, 2));
