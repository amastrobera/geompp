...
<details open>
<summary><b> &nbsp; 2. Math tools</b></summary>

<details closed>
<summary><b> &nbsp; &nbsp; 2.1 Linear Algebra (geompp::maths) </b></summary>
...
2. `solve_cramer()` solves the same `A x = b` system a different way — replace column `i` of `A` with `b`, `x_i = det(A_i) / det(A)` — useful when a caller specifically wants that closed form (e.g. to inspect one unknown's ratio in isolation) rather than the faster, more numerically stable elimination `solve_gauss()` runs.
  ...
  // Matrix4 homogeneous-transform factories -- what TransformBuilder3D (§2.2) composes.
...
<details closed>
<summary><b> &nbsp; &nbsp; 2.2 Affine Transformations (geompp::transformations) </b></summary>
...
- A **set of operations** applied **sequentially**
  ...
  with the previous section's transform:
    ...
    ```
      ...
      // or, equivalently, in one step -- skips the intermediate matrix entirely:
      auto new_primitive = builder.Apply(primitive);
    ```
...
<details open>
<summary><b> &nbsp; 3. Geometry Operations</b></summary>

<details closed>
<summary><b> &nbsp; &nbsp; 3.1 Interpolation </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 3.2 Containment </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 3.3 Intersection </b></summary>

<details closed>
<summary><b> &nbsp; &nbsp; &nbsp; 3.3.1 Primitive vs Primitive </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; &nbsp; 3.3.2 Set of Segments </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; &nbsp; 3.3.3 Split a complex polygon </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; &nbsp; 3.3.4 Triangle &times; Triangle </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 3.4 Overlap </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; &nbsp; 3.4.1 Triangle &times; Triangle (coplanar) </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; &nbsp; 3.5.1 Triangle &times; Triangle (contact only) </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 3.6 Polyline Overlaps / Touches </b></summary>
...
<details open>
<summary><b> &nbsp; 4. Planes </b></summary>

<details closed>
<summary><b> &nbsp; &nbsp; 4.1 Coplanarity, winding order, and polygon with holes </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 4.2 Projecting points onto a plane </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 4.3 Planar vs non-planar Polyline3D </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 4.4 View2D — streaming 3D points to 2D </b></summary>
...
<details open>
<summary><b> &nbsp; 5. PCA on a 3D point cloud </b></summary>
...
<details open>
<summary><b> &nbsp; 6. Bounding containers </b></summary>

<details closed>
<summary><b> &nbsp; &nbsp; 6.1 Simple containers for quick rejection </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 6.2 Convex hull </b></summary>

<details closed>
<summary><b> &nbsp; &nbsp; &nbsp; 6.2.1 Convex hull of a point cloud </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; &nbsp; 6.2.2 Convex hull of a polygon </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; &nbsp; 6.2.3 Convex hull of a simple polyline </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 6.3 Oriented Minimum Bounding Rectangle </b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 6.4 Polygon extreme points </b></summary>
...
<details open>
<summary><b> &nbsp; 7. Distance </b></summary>

<details closed>
<summary><b> &nbsp; &nbsp; 7.1 from Point</b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 7.2 from Other primitives</b></summary>
...
<details open>
<summary><b> &nbsp; 8. Polygon tangents</b></summary>

<details closed>
<summary><b> &nbsp; &nbsp; 8.1 Point to Polygon</b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 8.2 Polygon to Polygon</b></summary>
...
<details open>
<summary><b> &nbsp; 9. Polyline operations</b></summary>

<details closed>
<summary><b> &nbsp; &nbsp; 9.1 Decimation / reduction</b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 9.2 Corner smoothing with Bezier curve</b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 9.3 Expand / smooth a polyline</b></summary>
...
<details open>
<summary><b> &nbsp; 10. Polygon boolean operations </b></summary>
...
<summary><b> &nbsp; 11. Meshes</b></summary>
  ...
  throws if any input polygon does. `ConnectedMesh2D`/`ConnectedMesh3D` (§11.3) are the same idea as
  ...
  - A **T-junction** — a vertex partially overlapping an edge (a wall's corner landing halfway along a
    ...
    keep its old shape (see §11.5 for the exact behavior of each, with pictures).
  ...
  silently repaired. The batch `triangulate(vector<Polygon2D>, ...)` free function (§12) is the one place
  that repairs instead of rejecting by default — see there for why.

<details closed>
<summary><b> &nbsp; &nbsp; 11.1 Triangle mesh (Mesh2D / Mesh3D)</b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 11.2 Polygon mesh (PolyMesh2D / PolyMesh3D)</b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 11.3 Connected mesh (ConnectedMesh2D / ConnectedMesh3D)</b></summary>
...
<details closed>
<summary><b> &nbsp; &nbsp; 11.4 Converting between mesh representations</b></summary>
  ...
  - **`PolyMesh2D`/`PolyMesh3D` → `Mesh2D`/`Mesh3D`**, via `Triangulate()` (§12 below): triangulates
    every arbitrary-sided facet independently and combines the results into one triangle mesh. Use it
    when a mesh was authored/edited as flat n-gon panels (§11.2 — rooms, walls, CAD/BIM-style
  ...
  // Start from a PolyMesh2D: two quads sharing an edge (same shape as §11.2's example).
  auto p0 = g::Polygon2D::Make({g::Point2D(0, 0), g::Point2D(1, 0), g::Point2D(1, 1), g::Point2D(0, 1)});
  auto p1 = g::Polygon2D::Make({g::Point2D(1, 0), g::Point2D(2, 0), g::Point2D(2, 1), g::Point2D(1, 1)});
...
<details closed>
<summary><b> &nbsp; &nbsp; 11.5 Fixing a non-conforming mesh</b></summary>

  `PolyMesh2D/3D::FromPolygons()` and `Mesh2D/3D::FromTriangles()` both always reject a non-conforming
  batch of facets outright (§11, "every edge has at most 1 neighbor") — but a T-junction specifically is
...
<details open>
<summary><b> &nbsp; 12. Triangulation</b></summary>
  ...
  `Polygon2D/3D::Triangulate()` and `PolyMesh2D/3D::Triangulate()` (§11.4) wrap the free function with
...
<details open>
<summary><b> &nbsp; 13. Polygonization</b></summary>

The reverse of triangulation (§12): `polygonize()` merges triangles back into
...
polygons (`merge()`), and as a member function of a mesh `Mesh::Polygonize()`.
 ...
 <summary><b> &nbsp; &nbsp; 13.4 Mesh::Polygonize </b></summary>
  ...
  a `PolyMesh2D/3D` (§11.2) instead of a bare list.
