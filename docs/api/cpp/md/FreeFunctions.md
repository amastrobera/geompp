...
[`ExtremePoints`](ExtremePoints.md)` < `[`Point2D`](Point2D.md)` > find_extreme_points(`[`Polygon2D`](Polygon2D.md)` const & polygon, `[`Line2D`](Line2D.md)` const & line)`
...
- `polygon` ([`Polygon2D`](Polygon2D.md) const &) — The polygon whose vertices are searched (holes are ignored — only the outer ring matters).
- `line` ([`Line2D`](Line2D.md) const &) — The line whose Direction() defines the axis of projection.

**Returns** — [ExtremePoints](ExtremePoints.md) {min_point, max_point} — the outer-ring vertices with least / greatest projection.

[`ExtremePoints`](ExtremePoints.md)` < `[`Point3D`](Point3D.md)` > find_extreme_points(`[`Polygon3D`](Polygon3D.md)` const & polygon, `[`Line3D`](Line3D.md)` const & line)`
...
- `polygon` ([`Polygon3D`](Polygon3D.md) const &) — The polygon whose vertices are searched (holes are ignored — only the outer ring matters).
- `line` ([`Line3D`](Line3D.md) const &) — The line whose Direction() defines the axis of projection.

**Returns** — [ExtremePoints](ExtremePoints.md) {min_point, max_point} — the outer-ring vertices with least / greatest projection.

## `principal_axes`

[`CoordinateFrame`](CoordinateFrame.md)` principal_axes(std::vector< `[`Point3D`](Point3D.md)` > const & points)`

Computes the three principal axes of a point cloud using PCA (Jacobi eigendecomposition).

**Parameters**

- `points` (std::vector< [`Point3D`](Point3D.md) > const &) — The point cloud. Must contain at least 3 non-collinear points.
...
[`Vector3D`](Vector3D.md)` principal_normal(std::vector< `[`Point3D`](Point3D.md)` > const & points)`
...
[`Vector3D`](Vector3D.md)` principal_direction(std::vector< `[`Point3D`](Point3D.md)` > const & points)`
...
`template <typename Points> std::vector< Points > clip(Points const & clipper_loop, Points const & subject_loop)`
...
- `clipper_loop` (`Points const &`) — The clip region's vertices, in order. Last point must NOT repeat the first — the loop is treated as implicitly closed (an edge connects the last vertex back to the first).
- `subject_loop` (`Points const &`) — The subject's vertices, same "implicitly closed, no repeated first point" convention.
...
`template std::vector< std::vector< `[`Point2D`](Point2D.md)` > > clip(std::vector< `[`Point2D`](Point2D.md)` > const & , std::vector< `[`Point2D`](Point2D.md)` > const & )`


**Parameters**


`template std::vector< std::vector< `[`Point3D`](Point3D.md)` > > clip(std::vector< `[`Point3D`](Point3D.md)` > const & , std::vector< `[`Point3D`](Point3D.md)` > const & )`
...
`double distance_to(`[`Polygon2D`](Polygon2D.md)` const & polygon, `[`Line2D`](Line2D.md)` const & line)`
...
`double distance_to(`[`Polygon3D`](Polygon3D.md)` const & polygon, `[`Line3D`](Line3D.md)` const & line)`
...
[`PolygonTangents`](PolygonTangents.md)` < `[`LineSegment2D`](LineSegment2D.md)` > tangents_to(`[`Polygon2D`](Polygon2D.md)` const & polygon, `[`Point2D`](Point2D.md)` const & p)`
...
[`PolygonTangents`](PolygonTangents.md)` < `[`LineSegment2D`](LineSegment2D.md)` > tangents_to(`[`Polygon2D`](Polygon2D.md)` const & polygon, `[`Polygon2D`](Polygon2D.md)` const & other)`
...
- `polygon` ([`Polygon2D`](Polygon2D.md) const &)
- `other` ([`Polygon2D`](Polygon2D.md) const &)

[`PolygonTangents`](PolygonTangents.md)` < `[`LineSegment3D`](LineSegment3D.md)` > tangents_to(`[`Polygon3D`](Polygon3D.md)` const & polygon, `[`Point3D`](Point3D.md)` const & p)`
...
[`PolygonTangents`](PolygonTangents.md)` < `[`LineSegment3D`](LineSegment3D.md)` > tangents_to(`[`Polygon3D`](Polygon3D.md)` const & polygon, `[`Polygon3D`](Polygon3D.md)` const & other)`
...
`template std::vector< `[`Point2D`](Point2D.md)` > dist_decimation(std::vector< `[`Point2D`](Point2D.md)` > const & , double threshold)`
...
`template std::vector< `[`Point3D`](Point3D.md)` > dist_decimation(std::vector< `[`Point3D`](Point3D.md)` > const & , double threshold)`
...
`template <typename Points> Points rdp_decimation(Points const & points, double threshold)`
...
`template std::vector< `[`Point2D`](Point2D.md)` > rdp_decimation(std::vector< `[`Point2D`](Point2D.md)` > const & , double threshold)`
...
`template std::vector< `[`Point3D`](Point3D.md)` > rdp_decimation(std::vector< `[`Point3D`](Point3D.md)` > const & , double threshold)`
...
`template <typename Points> Points vw_decimation(Points const & points, double threshold)`
...
`template std::vector< `[`Point2D`](Point2D.md)` > vw_decimation(std::vector< `[`Point2D`](Point2D.md)` > const & , double threshold)`
...
`template std::vector< `[`Point3D`](Point3D.md)` > vw_decimation(std::vector< `[`Point3D`](Point3D.md)` > const & , double threshold)`
...
`template <typename typename PointT> std::vector< PointT > bezier_smoothing_2(PointT p0, PointT p1, PointT p2, double smoothness, double min_distance, double min_segment_length)`
...
`template std::vector< `[`Point2D`](Point2D.md)` > bezier_smoothing_2(`[`Point2D`](Point2D.md)` p0, `[`Point2D`](Point2D.md)` p1, `[`Point2D`](Point2D.md)` p2, double smoothness, double min_distance, double min_segment_length)`
...
`template std::vector< `[`Point3D`](Point3D.md)` > bezier_smoothing_2(`[`Point3D`](Point3D.md)` p0, `[`Point3D`](Point3D.md)` p1, `[`Point3D`](Point3D.md)` p2, double smoothness, double min_distance, double min_segment_length)`
...
`template <typename typename PointT> std::vector< PointT > bezier_smoothing_2(PointT p0, PointT p1, PointT p2, double smoothness, int num_segments, double min_segment_length)`
...
`template std::vector< `[`Point2D`](Point2D.md)` > bezier_smoothing_2(`[`Point2D`](Point2D.md)` p0, `[`Point2D`](Point2D.md)` p1, `[`Point2D`](Point2D.md)` p2, double smoothness, int num_segments, double min_segment_length)`
...
`template std::vector< `[`Point3D`](Point3D.md)` > bezier_smoothing_2(`[`Point3D`](Point3D.md)` p0, `[`Point3D`](Point3D.md)` p1, `[`Point3D`](Point3D.md)` p2, double smoothness, int num_segments, double min_segment_length)`
...
`template <typename typename PointT> std::vector< PointT > polyline_expansion(std::vector< PointT > const & input, `[`PolylineExpansionParams`](PolylineExpansionParams.md)` const & settings)`
...
- `input` (`std::vector< PointT > const &`) — the knots to round; must have at least 1 point (0 and 1-point input is a no-op).
- `settings` ([`PolylineExpansionParams`](PolylineExpansionParams.md) const &) — bundles smoothness, sampling density, and the tiny-corner skip threshold. Defaults to {0.5, FixedSegments, 4, 0.1, DOUBLE_EPSILON} .
...
`template std::vector< `[`Point2D`](Point2D.md)` > polyline_expansion(std::vector< `[`Point2D`](Point2D.md)` > const & input, `[`PolylineExpansionParams`](PolylineExpansionParams.md)` const & settings)`


**Parameters**

- `input` (std::vector< [`Point2D`](Point2D.md) > const &)
- `settings` ([`PolylineExpansionParams`](PolylineExpansionParams.md) const &)

`template std::vector< `[`Point3D`](Point3D.md)` > polyline_expansion(std::vector< `[`Point3D`](Point3D.md)` > const & input, `[`PolylineExpansionParams`](PolylineExpansionParams.md)` const & settings)`
...
`std::vector< `[`Triangle2D`](Triangle2D.md)` > triangulate(std::vector< `[`Polygon2D`](Polygon2D.md)` > const & polygons, `[`TriangulationParams`](TriangulationParams.md)` const & settings)`
...
`std::vector< `[`Triangle3D`](Triangle3D.md)` > triangulate(std::vector< `[`Point3D`](Point3D.md)` > const & input, `[`Vector3D`](Vector3D.md)` normal, `[`TriangulationParams`](TriangulationParams.md)` const & settings)`
...
`std::vector< `[`Triangle3D`](Triangle3D.md)` > triangulate(std::vector< `[`Point3D`](Point3D.md)` > const & input, `[`TriangulationParams`](TriangulationParams.md)` const & settings)`
...
`std::vector< `[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point2D`](Point2D.md)` > > validate_adjacency(std::vector< `[`Polygon2D`](Polygon2D.md)` > const & facets)`
...
- `facets` (std::vector< [`Polygon2D`](Polygon2D.md) > const &) — each facet's outer ring (e.g. [Polygon2D](Polygon2D.md)/3D::Perimeter(), or a [Triangle2D](Triangle2D.md)/3D's 3 vertices).

**Returns** — every violation found (both T-junctions and non-manifold edges); empty if conforming.

`std::vector< `[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point2D`](Point2D.md)` > > validate_adjacency(std::vector< `[`Triangle2D`](Triangle2D.md)` > const & facets)`


**Parameters**

- `facets` (std::vector< [`Triangle2D`](Triangle2D.md) > const &)

`std::vector< `[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point3D`](Point3D.md)` > > validate_adjacency(std::vector< `[`Polygon3D`](Polygon3D.md)` > const & facets)`


**Parameters**

- `facets` (std::vector< [`Polygon3D`](Polygon3D.md) > const &)

`std::vector< `[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point3D`](Point3D.md)` > > validate_adjacency(std::vector< `[`Triangle3D`](Triangle3D.md)` > const & facets)`


**Parameters**

- `facets` (std::vector< [`Triangle3D`](Triangle3D.md) > const &)

`std::vector< `[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point2D`](Point2D.md)` > > validate_adjacency(std::vector< std::vector< `[`Point2D`](Point2D.md)` > > const & facet_rings)`
...
- `facet_rings` (std::vector< std::vector< [`Point2D`](Point2D.md) > > const &)

`std::vector< `[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point3D`](Point3D.md)` > > validate_adjacency(std::vector< std::vector< `[`Point3D`](Point3D.md)` > > const & facet_rings)`


**Parameters**

- `facet_rings` (std::vector< std::vector< [`Point3D`](Point3D.md) > > const &)

## `fix_adjacency`

`std::vector< std::vector< `[`Point2D`](Point2D.md)` > > fix_adjacency(std::vector< `[`Polygon2D`](Polygon2D.md)` > const & facets)`
...
- `facets` (std::vector< [`Polygon2D`](Polygon2D.md) > const &)

`std::vector< std::vector< `[`Point3D`](Point3D.md)` > > fix_adjacency(std::vector< `[`Polygon3D`](Polygon3D.md)` > const & facets)`
...
`std::vector< `[`Triangle2D`](Triangle2D.md)` > fix_adjacency(std::vector< `[`Triangle2D`](Triangle2D.md)` > const & facets)`
...
`std::vector< `[`Triangle3D`](Triangle3D.md)` > fix_adjacency(std::vector< `[`Triangle3D`](Triangle3D.md)` > const & facets)`
...
`bool has_intersections(std::vector< `[`LineSegment2D`](LineSegment2D.md)` > const & segments)`

Shamos-Hoey: true if any two segments in the set intersect.

**Parameters**

- `segments` (std::vector< [`LineSegment2D`](LineSegment2D.md) > const &)

## `find_intersections`

`std::vector< `[`Point2D`](Point2D.md)` > find_intersections(std::vector< `[`LineSegment2D`](LineSegment2D.md)` > const & segments)`
...
`bool are_coplanar(std::vector< `[`Point3D`](Point3D.md)` > const & points, std::optional< `[`Plane`](Plane.md)` > plane)`


**Parameters**

- `points` (std::vector< [`Point3D`](Point3D.md) > const &)
- `plane` (std::optional< [`Plane`](Plane.md) >)

## `closest_world_plane_to`

[`Plane`](Plane.md)` closest_world_plane_to(std::vector< `[`Point3D`](Point3D.md)` > const & points)`
...
`double signed_area(std::vector< `[`Point3D`](Point3D.md)` > const & points, std::optional< `[`Plane`](Plane.md)` > plane)`
...
`double signed_area(std::vector< `[`Point2D`](Point2D.md)` > const & points)`
...
`bool are_ccw(std::vector< `[`Point3D`](Point3D.md)` > const & points, std::optional< `[`Plane`](Plane.md)` > ref_plane)`


**Parameters**

- `points` (std::vector< [`Point3D`](Point3D.md) > const &)
- `ref_plane` (std::optional< [`Plane`](Plane.md) >)

`bool are_ccw(std::vector< `[`Point2D`](Point2D.md)` > const & points)`
...
`bool are_cw(std::vector< `[`Point3D`](Point3D.md)` > const & points, std::optional< `[`Plane`](Plane.md)` > ref_plane)`
...
`bool are_cw(std::vector< `[`Point2D`](Point2D.md)` > const & points)`
...
[`Point3D`](Point3D.md)` centroid(std::vector< `[`Point3D`](Point3D.md)` > const & points, std::optional< `[`Plane`](Plane.md)` > plane)`
...
[`Point2D`](Point2D.md)` centroid(std::vector< `[`Point2D`](Point2D.md)` > const & points)`
...
`bool are_collinear(`[`Point2D`](Point2D.md)` const & p1, `[`Point2D`](Point2D.md)` const & p2, `[`Point2D`](Point2D.md)` const & p3)`
...
- `p3` ([`Point2D`](Point2D.md) const &)

`bool are_collinear(`[`Point3D`](Point3D.md)` const & p1, `[`Point3D`](Point3D.md)` const & p2, `[`Point3D`](Point3D.md)` const & p3)`
...
- `p3` ([`Point3D`](Point3D.md) const &)

## `remove_consecutive_duplicates`

`std::vector< `[`Point2D`](Point2D.md)` > remove_consecutive_duplicates(std::vector< `[`Point2D`](Point2D.md)` > const & points)`
...
`std::vector< `[`Point2D`](Point2D.md)` > remove_consecutive_duplicates(std::vector< `[`Point2D`](Point2D.md)` > && points)`
...
`std::vector< `[`Point3D`](Point3D.md)` > remove_consecutive_duplicates(std::vector< `[`Point3D`](Point3D.md)` > const & points)`
...
`std::vector< `[`Point3D`](Point3D.md)` > remove_consecutive_duplicates(std::vector< `[`Point3D`](Point3D.md)` > && points)`
...
`std::vector< `[`Point2D`](Point2D.md)` > remove_duplicates(std::vector< `[`Point2D`](Point2D.md)` > const & points)`
...
`std::vector< `[`Point3D`](Point3D.md)` > remove_duplicates(std::vector< `[`Point3D`](Point3D.md)` > const & points)`
...
`std::vector< `[`Point2D`](Point2D.md)` > remove_collinear(std::vector< `[`Point2D`](Point2D.md)` > const & points)`
...
`std::vector< `[`Point2D`](Point2D.md)` > remove_collinear(std::vector< `[`Point2D`](Point2D.md)` > && points)`
...
`std::vector< `[`Point3D`](Point3D.md)` > remove_collinear(std::vector< `[`Point3D`](Point3D.md)` > const & points)`
...
`std::vector< `[`Point3D`](Point3D.md)` > remove_collinear(std::vector< `[`Point3D`](Point3D.md)` > && points)`
...
[`Point2D`](Point2D.md)` linear_combination(std::vector< `[`Point2D`](Point2D.md)` > const & points, std::vector< double > const & weights)`


**Parameters**

- `points` (std::vector< [`Point2D`](Point2D.md) > const &)
- `weights` (`std::vector< double > const &`)

[`Point3D`](Point3D.md)` linear_combination(std::vector< `[`Point3D`](Point3D.md)` > const & points, std::vector< double > const & weights)`
...
[`Point2D`](Point2D.md)` average(std::vector< `[`Point2D`](Point2D.md)` > const & points)`
...
[`Point3D`](Point3D.md)` average(std::vector< `[`Point3D`](Point3D.md)` > const & points)`
...
`std::vector< `[`Point2D`](Point2D.md)` > convex_hull(std::vector< `[`Point2D`](Point2D.md)` > const & points)`
...
`std::vector< `[`Point3D`](Point3D.md)` > convex_hull(std::vector< `[`Point3D`](Point3D.md)` > const & points, std::optional< `[`Vector3D`](Vector3D.md)` > normal)`


**Parameters**

- `points` (std::vector< [`Point3D`](Point3D.md) > const &)
- `normal` (std::optional< [`Vector3D`](Vector3D.md) >)

## `lerp`

[`Point2D`](Point2D.md)` lerp(`[`Point2D`](Point2D.md)` const & P0, `[`Point2D`](Point2D.md)` const & P1, double t)`
...
[`Point3D`](Point3D.md)` lerp(`[`Point3D`](Point3D.md)` const & P0, `[`Point3D`](Point3D.md)` const & P1, double t)`
