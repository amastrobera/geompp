...
- `t` ([`Triangle3D`](Triangle3D.md) const &)
...
`std::optional< `[`Point3D`](Point3D.md)` > Intersection(Line3D const & other) const`
...
`std::optional< `[`Ray3D`](Ray3D.md)` > Overlap(`[`Ray3D`](Ray3D.md)` const & ray) const`
