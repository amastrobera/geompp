...
**static** `PolyMesh3D^ FromWkt(System::String^ wkt)`
...
**static** `PolyMesh3D^ FromFile(System::String^ path)`
...
[`Mesh3D`](Mesh3D.md)`^ Triangulate(`[`TriangulationParams`](TriangulationParams.md)`::Strategy^ strategy)`
