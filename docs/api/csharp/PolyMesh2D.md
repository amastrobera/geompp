...
**static** `PolyMesh2D^ FromWkt(System::String^ wkt)`
...
**static** `PolyMesh2D^ FromFile(System::String^ path)`
...
[`Mesh2D`](Mesh2D.md)`^ Triangulate(`[`TriangulationParams`](TriangulationParams.md)`::Strategy^ strategy)`
