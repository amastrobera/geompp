...
**static** `Matrix^ Translation(`[`Vector`](Vector.md)` < T, 3 >^ offset)`
...
**static** `Matrix^ Translation(`[`Vector`](Vector.md)` < T, 2 >^ offset)`
...
**static** `Matrix^ Rotation(T^ angle_rad, `[`Vector`](Vector.md)` < T, 3 >^ axis)`
...
**static** `Matrix^ Reflection(`[`Vector`](Vector.md)` < T, 3 >^ normal)`
...
**static** `Matrix^ Reflection(`[`Vector`](Vector.md)` < T, 2 >^ normal)`
