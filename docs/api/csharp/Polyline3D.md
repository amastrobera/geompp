...
`Polyline3D^ Reduce(`[`PolylineDecimationParams`](PolylineDecimationParams.md)`^ settings)`
...
`Polyline3D^ Expand(`[`PolylineExpansionParams`](PolylineExpansionParams.md)`^ settings)`
