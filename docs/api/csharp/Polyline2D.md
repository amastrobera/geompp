...
`Polyline2D^ Reduce(`[`PolylineDecimationParams`](PolylineDecimationParams.md)`^ settings)`
...
`Polyline2D^ Expand(`[`PolylineExpansionParams`](PolylineExpansionParams.md)`^ settings)`
