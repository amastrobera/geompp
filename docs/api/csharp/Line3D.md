...
**static** `Line3D^ Make(`[`Point3D`](Point3D.md)`^ p0, `[`Point3D`](Point3D.md)`^ p1)`
...
**static** `Line3D^ Make(`[`Point3D`](Point3D.md)`^ orig, `[`Vector3D`](Vector3D.md)`^ dir)`
...
- `wkt` (`System::String^`) — Well-Known Text string of the form "LINE (x0 y0 z0, x1 y1 z1)".
...
- `path` (`System::String^`) — Filesystem path containing a WKT line.
...
[`LineSegment3D`](LineSegment3D.md)`^  (nullable) Distance(Line3D^ other)`
...
[`LineSegment3D`](LineSegment3D.md)`^  (nullable) Distance(`[`Ray3D`](Ray3D.md)`^ ray)`
...
- `path` (`System::String^`) — Filesystem path to write to. Existing content is overwritten.
...
`bool Intersects(`[`Triangle3D`](Triangle3D.md)`^ t)`
...
[`Point3D`](Point3D.md)`^  (nullable) Intersection(Line3D^ other)`
...
`Line3D^  (nullable) Overlap(Line3D^ line)`
...
[`Ray3D`](Ray3D.md)`^  (nullable) Overlap(`[`Ray3D`](Ray3D.md)`^ ray)`
