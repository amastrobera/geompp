# `FreeFunctions` (Python)

Free functions in `geompp::geometry` (not methods on a class — call them directly).

## `find_extreme_points`

`find_extreme_points(polygon: `[`Polygon2D`](Polygon2D.md)`, line: `[`Line2D`](Line2D.md)`) -> `[`ExtremePoints`](ExtremePoints.md)` < `[`Point2D`](Point2D.md)` >`
...
`find_extreme_points(polygon: `[`Polygon3D`](Polygon3D.md)`, line: `[`Line3D`](Line3D.md)`) -> `[`ExtremePoints`](ExtremePoints.md)` < `[`Point3D`](Point3D.md)` >`
...
`principal_axes(points: list[`[`Point3D`](Point3D.md)`]) -> `[`CoordinateFrame`](CoordinateFrame.md)

Computes the three principal axes of a point cloud using PCA (Jacobi eigendecomposition).

**Parameters**

- `points` (list[`[Point3D`](Point3D.md)]) — The point cloud. Must contain at least 3 non-collinear points.
...
`principal_normal(points: list[`[`Point3D`](Point3D.md)`]) -> `[`Vector3D`](Vector3D.md)
...
`principal_direction(points: list[`[`Point3D`](Point3D.md)`]) -> `[`Vector3D`](Vector3D.md)
...
`clip(clipper_loop: Points, subject_loop: Points) -> list[Points]`
...
`clip(?: list[`[`Point2D`](Point2D.md)`], ?: list[`[`Point2D`](Point2D.md)`]) -> template std::vector< std::vector< `[`Point2D`](Point2D.md)` > >`


**Parameters**


`clip(?: list[`[`Point3D`](Point3D.md)`], ?: list[`[`Point3D`](Point3D.md)`]) -> template std::vector< std::vector< `[`Point3D`](Point3D.md)` > >`
...
`distance_to(polygon: `[`Polygon2D`](Polygon2D.md)`, line: `[`Line2D`](Line2D.md)`) -> float`
...
`distance_to(polygon: `[`Polygon3D`](Polygon3D.md)`, line: `[`Line3D`](Line3D.md)`) -> float`
...
`tangents_to(polygon: `[`Polygon2D`](Polygon2D.md)`, p: `[`Point2D`](Point2D.md)`) -> `[`PolygonTangents`](PolygonTangents.md)` < `[`LineSegment2D`](LineSegment2D.md)` >`
...
`tangents_to(polygon: `[`Polygon2D`](Polygon2D.md)`, other: `[`Polygon2D`](Polygon2D.md)`) -> `[`PolygonTangents`](PolygonTangents.md)` < `[`LineSegment2D`](LineSegment2D.md)` >`
...
`tangents_to(polygon: `[`Polygon3D`](Polygon3D.md)`, p: `[`Point3D`](Point3D.md)`) -> `[`PolygonTangents`](PolygonTangents.md)` < `[`LineSegment3D`](LineSegment3D.md)` >`
...
`tangents_to(polygon: `[`Polygon3D`](Polygon3D.md)`, other: `[`Polygon3D`](Polygon3D.md)`) -> `[`PolygonTangents`](PolygonTangents.md)` < `[`LineSegment3D`](LineSegment3D.md)` >`
...
`polygonize(triangles: list[`[`Triangle2D`](Triangle2D.md)`], params: `[`PolygonizationParams`](PolygonizationParams.md)`) -> list[`[`Polygon2D`](Polygon2D.md)`]`
...
- `triangles` (list[`[Triangle2D`](Triangle2D.md)]) — The triangles to polygonize. Order is not required to reflect adjacency.
...
`polygonize(triangles: list[`[`Triangle3D`](Triangle3D.md)`], params: `[`PolygonizationParams`](PolygonizationParams.md)`) -> list[`[`Polygon3D`](Polygon3D.md)`]`
...
- `triangles` (list[`[Triangle3D`](Triangle3D.md)]) — The triangles to polygonize. Order is not required to reflect adjacency.
- `params` ([`PolygonizationParams`](PolygonizationParams.md)) — Which polygonization strategy to run see [PolygonizationParams](PolygonizationParams.md)::Strategy .
...
`merge(polygons: list[`[`Polygon2D`](Polygon2D.md)`]) -> list[`[`Polygon2D`](Polygon2D.md)`]`
...
- `polygons` (list[`[Polygon2D`](Polygon2D.md)]) — The polygons to merge. Order doesn't matter; polygons that don't touch anything simply pass through as their own separate output piece.

**Returns** — One [Polygon2D](Polygon2D.md) per disjoint merged region.

`merge(polygons: list[`[`Polygon3D`](Polygon3D.md)`]) -> list[`[`Polygon3D`](Polygon3D.md)`]`
...
- `polygons` (list[`[Polygon3D`](Polygon3D.md)]) — The polygons to merge. Order doesn't matter.

**Returns** — One [Polygon3D](Polygon3D.md) per disjoint merged region.

## `dist_decimation`

`dist_decimation(points: Points, threshold: float) -> Points`
...
`dist_decimation(?: list[`[`Point2D`](Point2D.md)`], threshold: float) -> template std::vector< `[`Point2D`](Point2D.md)` >`
...
`dist_decimation(?: list[`[`Point3D`](Point3D.md)`], threshold: float) -> template std::vector< `[`Point3D`](Point3D.md)` >`
...
`rdp_decimation(points: Points, threshold: float) -> Points`
...
`rdp_decimation(?: list[`[`Point2D`](Point2D.md)`], threshold: float) -> template std::vector< `[`Point2D`](Point2D.md)` >`
...
`rdp_decimation(?: list[`[`Point3D`](Point3D.md)`], threshold: float) -> template std::vector< `[`Point3D`](Point3D.md)` >`
...
`vw_decimation(points: Points, threshold: float) -> Points`
...
`vw_decimation(?: list[`[`Point2D`](Point2D.md)`], threshold: float) -> template std::vector< `[`Point2D`](Point2D.md)` >`
...
`vw_decimation(?: list[`[`Point3D`](Point3D.md)`], threshold: float) -> template std::vector< `[`Point3D`](Point3D.md)` >`
...
`bezier_smoothing_2(p0: PointT, p1: PointT, p2: PointT, smoothness: float, min_distance: float, min_segment_length: float) -> list[PointT]`
...
`bezier_smoothing_2(p0: `[`Point3D`](Point3D.md)`, p1: `[`Point3D`](Point3D.md)`, p2: `[`Point3D`](Point3D.md)`, smoothness: float, min_distance: float, min_segment_length: float) -> template std::vector< `[`Point3D`](Point3D.md)` >`
...
`bezier_smoothing_2(p0: PointT, p1: PointT, p2: PointT, smoothness: float, num_segments: int, min_segment_length: float) -> list[PointT]`
...
- `min_segment_length` (`float`) — see the min_distance overload — same skip-trim/skip-corner behavior and DOUBLE_EPSILON default.

**Returns** — num_segments + 1 points sampled evenly from the tangent point near p0 to the tangent point near p2.

`bezier_smoothing_2(p0: `[`Point2D`](Point2D.md)`, p1: `[`Point2D`](Point2D.md)`, p2: `[`Point2D`](Point2D.md)`, smoothness: float, num_segments: int, min_segment_length: float) -> template std::vector< `[`Point2D`](Point2D.md)` >`
...
`bezier_smoothing_2(p0: `[`Point3D`](Point3D.md)`, p1: `[`Point3D`](Point3D.md)`, p2: `[`Point3D`](Point3D.md)`, smoothness: float, num_segments: int, min_segment_length: float) -> template std::vector< `[`Point3D`](Point3D.md)` >`
...
`polyline_expansion(input: list[PointT], settings: `[`PolylineExpansionParams`](PolylineExpansionParams.md)`) -> list[PointT]`
...
- `input` (`list[PointT]`) — the knots to round; must have at least 1 point (0 and 1-point input is a no-op).
...
`polyline_expansion(input: list[`[`Point2D`](Point2D.md)`], settings: `[`PolylineExpansionParams`](PolylineExpansionParams.md)`) -> template std::vector< `[`Point2D`](Point2D.md)` >`


**Parameters**

- `input` (list[`[Point2D`](Point2D.md)])
- `settings` ([`PolylineExpansionParams`](PolylineExpansionParams.md))

`polyline_expansion(input: list[`[`Point3D`](Point3D.md)`], settings: `[`PolylineExpansionParams`](PolylineExpansionParams.md)`) -> template std::vector< `[`Point3D`](Point3D.md)` >`


**Parameters**

- `input` (list[`[Point3D`](Point3D.md)])
- `settings` ([`PolylineExpansionParams`](PolylineExpansionParams.md))

## `triangulate`

`triangulate(input: list[`[`Point2D`](Point2D.md)`], settings: `[`TriangulationParams`](TriangulationParams.md)`) -> list[`[`Triangle2D`](Triangle2D.md)`]`

Breaks down a simple polygon into triangles.

**Parameters**

- `input` (list[`[Point2D`](Point2D.md)]) — polygon's outer loop of points (assumed CCW) and no holes allowed
...
`triangulate(polygons: list[`[`Polygon2D`](Polygon2D.md)`], settings: `[`TriangulationParams`](TriangulationParams.md)`) -> list[`[`Triangle2D`](Triangle2D.md)`]`
...
- `polygons` (list[`[Polygon2D`](Polygon2D.md)]) — each facet's outer ring (no holes).
...
`triangulate(input: list[`[`Point3D`](Point3D.md)`], normal: `[`Vector3D`](Vector3D.md)`, settings: `[`TriangulationParams`](TriangulationParams.md)`) -> list[`[`Triangle3D`](Triangle3D.md)`]`
...
- `input` (list[`[Point3D`](Point3D.md)]) — polygon's outer loop of points (assumed CCW against the normal) and no holes allowed
...
`triangulate(input: list[`[`Point3D`](Point3D.md)`], settings: `[`TriangulationParams`](TriangulationParams.md)`) -> list[`[`Triangle3D`](Triangle3D.md)`]`
...
- `input` (list[`[Point3D`](Point3D.md)]) — polygon's outer loop of points (assumed CCW against their own normal) and no holes allowed
- `settings` ([`TriangulationParams`](TriangulationParams.md)) — options for functions inner workings (1) triangulation strategy options: user decides what algorithm to run EarClipping clips the first valid ear it finds in scan order. Most robust and general-purpose, and often close to O(n) in practice, but O(n²) worst-case and doesn't optimize triangle shape, so it can produce a visually thin sliver purely from scan order, even on ordinary input. EarClippingBestFit clips the best-scoring (least sliver-prone) valid ear every step instead of the first one. Same termination guarantee as EarClipping, but unconditionally ~O(n²) a full rescan of the current ring on every single clip, not just worst-case. [Default: prefers shape quality over raw speed.] MonotonePolygon: O(n log n) worst case, but requires a monotone polygon (or a decomposition into monotone pieces) Delaunay: O(n log n) worst case, but produces a triangulation that maximizes the minimum angle of all the angles of the triangles in the triangulation (avoiding skinny triangles) (2) simplicity: the input for the algo should be a simple polygon (no self-intersections) Guaranteed: the input is assumed to be a good at the users's own risk Assert: will throw if the user's input is not good Enforce: will check, and if not good, the user's input will be simplified in O(n log n) time (3) winding: the input points should be in counter clockwise order (CCW) Guaranteed: the input is assumed to be good at the users's own risk Assert: will throw if the user's input is not good Enforce: will check, and if not good, the user's input will be reversed in O(n) time (4) collinearity: the input points should not contain any collinear (including consecutive duplicates) points Guaranteed: the input is assumed to be good at the users's own risk Assert: will throw if the user's input is not good Enforce: will check, and if not good, the user's bad vertices will be removed in O(n) time
...
`validate_adjacency(facets: list[`[`Polygon2D`](Polygon2D.md)`]) -> list[`[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point2D`](Point2D.md)` >]`
...
- `facets` (list[`[Polygon2D`](Polygon2D.md)]) — each facet's outer ring (e.g. [Polygon2D](Polygon2D.md)/3D::Perimeter(), or a [Triangle2D](Triangle2D.md)/3D's 3 vertices).

**Returns** — every violation found (both T-junctions and non-manifold edges); empty if conforming.

`validate_adjacency(facets: list[`[`Triangle2D`](Triangle2D.md)`]) -> list[`[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point2D`](Point2D.md)` >]`


**Parameters**

- `facets` (list[`[Triangle2D`](Triangle2D.md)])

`validate_adjacency(facets: list[`[`Polygon3D`](Polygon3D.md)`]) -> list[`[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point3D`](Point3D.md)` >]`


**Parameters**

- `facets` (list[`[Polygon3D`](Polygon3D.md)])

`validate_adjacency(facets: list[`[`Triangle3D`](Triangle3D.md)`]) -> list[`[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point3D`](Point3D.md)` >]`


**Parameters**

- `facets` (list[`[Triangle3D`](Triangle3D.md)])

`validate_adjacency(facet_rings: list[list[`[`Point2D`](Point2D.md)`]]) -> list[`[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point2D`](Point2D.md)` >]`
...
- `facet_rings` (list[`list[[Point2D`](Point2D.md)]])

`validate_adjacency(facet_rings: list[list[`[`Point3D`](Point3D.md)`]]) -> list[`[`AdjacencyViolation`](AdjacencyViolation.md)` < `[`Point3D`](Point3D.md)` >]`


**Parameters**

- `facet_rings` (list[`list[[Point3D`](Point3D.md)]])

## `fix_adjacency`

`fix_adjacency(facets: list[`[`Polygon2D`](Polygon2D.md)`]) -> list[list[`[`Point2D`](Point2D.md)`]]`
...
- `facets` (list[`[Polygon2D`](Polygon2D.md)])

`fix_adjacency(facets: list[`[`Polygon3D`](Polygon3D.md)`]) -> list[list[`[`Point3D`](Point3D.md)`]]`
...
`fix_adjacency(facets: list[`[`Triangle2D`](Triangle2D.md)`]) -> list[`[`Triangle2D`](Triangle2D.md)`]`
...
`fix_adjacency(facets: list[`[`Triangle3D`](Triangle3D.md)`]) -> list[`[`Triangle3D`](Triangle3D.md)`]`
...
`has_intersections(segments: list[`[`LineSegment2D`](LineSegment2D.md)`]) -> bool`

Shamos-Hoey: true if any two segments in the set intersect.

**Parameters**

- `segments` (list[`[LineSegment2D`](LineSegment2D.md)])

## `find_intersections`

`find_intersections(segments: list[`[`LineSegment2D`](LineSegment2D.md)`]) -> list[`[`Point2D`](Point2D.md)`]`
...
`are_coplanar(points: list[`[`Point3D`](Point3D.md)`], plane: `[`Plane`](Plane.md)` | None) -> bool`


**Parameters**

- `points` (list[`[Point3D`](Point3D.md)])
- `plane` ([`Plane`](Plane.md) | None)

## `closest_world_plane_to`

`closest_world_plane_to(points: list[`[`Point3D`](Point3D.md)`]) -> `[`Plane`](Plane.md)
...
`signed_area(points: list[`[`Point3D`](Point3D.md)`], plane: `[`Plane`](Plane.md)` | None) -> float`
...
`signed_area(points: list[`[`Point2D`](Point2D.md)`]) -> float`
...
`are_ccw(points: list[`[`Point3D`](Point3D.md)`], ref_plane: `[`Plane`](Plane.md)` | None) -> bool`


**Parameters**

- `points` (list[`[Point3D`](Point3D.md)])
- `ref_plane` ([`Plane`](Plane.md) | None)

`are_ccw(points: list[`[`Point2D`](Point2D.md)`]) -> bool`
...
`are_cw(points: list[`[`Point3D`](Point3D.md)`], ref_plane: `[`Plane`](Plane.md)` | None) -> bool`
...
`are_cw(points: list[`[`Point2D`](Point2D.md)`]) -> bool`
...
`centroid(points: list[`[`Point3D`](Point3D.md)`], plane: `[`Plane`](Plane.md)` | None) -> `[`Point3D`](Point3D.md)
...
`centroid(points: list[`[`Point2D`](Point2D.md)`]) -> `[`Point2D`](Point2D.md)
...
`are_collinear(p1: `[`Point2D`](Point2D.md)`, p2: `[`Point2D`](Point2D.md)`, p3: `[`Point2D`](Point2D.md)`) -> bool`
...
`are_collinear(p1: `[`Point3D`](Point3D.md)`, p2: `[`Point3D`](Point3D.md)`, p3: `[`Point3D`](Point3D.md)`) -> bool`
...
`remove_consecutive_duplicates(points: list[`[`Point2D`](Point2D.md)`]) -> list[`[`Point2D`](Point2D.md)`]`
...
`remove_consecutive_duplicates(points: list[`[`Point3D`](Point3D.md)`]) -> list[`[`Point3D`](Point3D.md)`]`
...
`remove_duplicates(points: list[`[`Point2D`](Point2D.md)`]) -> list[`[`Point2D`](Point2D.md)`]`
...
`remove_duplicates(points: list[`[`Point3D`](Point3D.md)`]) -> list[`[`Point3D`](Point3D.md)`]`
...
`remove_duplicates(sorted_vec: list[float], epsilon: float) -> None`

removes duplicates from a sorted vector (duplicates are consecutive) input {0,0,0,1,2,3,4,4,5} --> output: {0,1,2,3,4,5}

**Parameters**

- `sorted_vec` (`list[float]`) — vector of sorted elements
- `epsilon` (`float`)

## `remove_collinear`

`remove_collinear(points: list[`[`Point2D`](Point2D.md)`]) -> list[`[`Point2D`](Point2D.md)`]`
...
`remove_collinear(points: list[`[`Point3D`](Point3D.md)`]) -> list[`[`Point3D`](Point3D.md)`]`
...
`linear_combination(points: list[`[`Point2D`](Point2D.md)`], weights: list[float]) -> `[`Point2D`](Point2D.md)
...
`linear_combination(points: list[`[`Point3D`](Point3D.md)`], weights: list[float]) -> `[`Point3D`](Point3D.md)
...
`average(points: list[`[`Point2D`](Point2D.md)`]) -> `[`Point2D`](Point2D.md)
...
`average(points: list[`[`Point3D`](Point3D.md)`]) -> `[`Point3D`](Point3D.md)
...
`convex_hull(points: list[`[`Point2D`](Point2D.md)`]) -> list[`[`Point2D`](Point2D.md)`]`
...
`convex_hull(points: list[`[`Point3D`](Point3D.md)`], normal: `[`Vector3D`](Vector3D.md)` | None) -> list[`[`Point3D`](Point3D.md)`]`


**Parameters**

- `points` (list[`[Point3D`](Point3D.md)])
- `normal` ([`Vector3D`](Vector3D.md) | None)

## `lerp`

`lerp(p0: `[`Point2D`](Point2D.md)`, p1: `[`Point2D`](Point2D.md)`, t: float) -> `[`Point2D`](Point2D.md)
...
`lerp(p0: `[`Point3D`](Point3D.md)`, p1: `[`Point3D`](Point3D.md)`, t: float) -> `[`Point3D`](Point3D.md)
