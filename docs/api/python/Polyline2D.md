...
`reduce(settings: `[`PolylineDecimationParams`](PolylineDecimationParams.md)`) -> Polyline2D`
...
`expand(settings: `[`PolylineExpansionParams`](PolylineExpansionParams.md)`) -> Polyline2D`
